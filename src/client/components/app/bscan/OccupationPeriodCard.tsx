    ...
    return <fieldset name="occupationPeriodReference" className="occupation-period-form section-card" data-reference-type={occupation.ReferenceTypeValueId}>
        ...
        <div className="occupation-period-details-grid" data-reference-type-value-id={occupation.ReferenceTypeValueId ?? ""}>
            <label>
                ...
                <select name="ReferenceTypeValueId" value={occupation.ReferenceTypeValueId ?? ""} required={true}>
            ...
            {occupation.ReferenceTypeValueId === 1075 ? <> {/* Gap */}
                <label>
                    ...
                    <input name="GapReason" list="gap-reason-options" type="text" value={occupation.GapReason ?? ""} required={true}/>
                </label>
                <label>
                    <span>What were you doing</span>
                    <input name="GapActivities" placeholder="I was..." type="text" value={occupation.GapActivities ?? ""}/>
                </label>
                <label>
                    <span>Where were you residing</span>
                    <textarea name="Address" placeholder="4 Privet Drive, Little Whinging, Surrey, 1234, United Kingdom" value={occupation.Address ?? ""}></textarea>
                </label>
                <label>
                    <span>How were you supporting yourself</span>
                    <input name="GapSupport" placeholder="By..." type="text" value={occupation.GapSupport ?? ""}/>
                </label>
            </> : occupation.ReferenceTypeValueId === 1077 ? <> {/* Education */}
                <label>
                    <span>Name of Institution</span>
                    <input name="CompanyName" type="text" placeholder="Example State University" value={occupation.CompanyName ?? ""} required={true}/>
                </label>
                <label>
                    <span>Contact Email</span>
                    <input name="Email" type="email" placeholder="abc@example.com" value={occupation.Email ?? ""} required={true}/>
                </label>
                <label>
                    <span>Qualification gained</span>
                    <input name="JobRole" type="text" placeholder="First Officer" value={occupation.JobRole ?? ""}/>
                </label>
                ...
                <label>
                    ...
                    <input name="CompanyName" type="text" placeholder="Example Airlines" value={occupation.CompanyName ?? ""} required={true}/>
                </label>
                <label>
                    <span>Contact Email</span>
                    <input name="Email" type="email" placeholder="abc@example.com" value={occupation.Email ?? ""} required={true}/>
                ...
                <label>
                    <span>Job Title</span>
                    <input name="JobRole" type="text" placeholder="Captain" value={occupation.JobRole ?? ""}/>
                </label>
                <label>
                    <span>Contact Person's Name</span>
                    <input name="RefereeName" type="text" placeholder="John Smith" value={occupation.RefereeName ?? ""}/>
                </label>
                {!occupation.EndDate ? undefined : <label>
                    <span>Reason for Leaving</span>
                    <input name="Comments" type="text" placeholder="This job was..." value={occupation.Comments ?? ""}/>
                </label>}
                <div>
                    <label className="inline-label">
                        <span>Can we obtain a reference from your last employer?</span>
                        <input name="ContactCurrentEmployer" type="checkbox" required={!occupation.ReasonForNotContactCurrentEmployer} checked={occupation.ContactCurrentEmployer}/>
                    </label>
                    {occupation.ContactCurrentEmployer ? undefined : <label className="inline-label">
                        <span>Reason?</span>
                        <input name="ReasonForNotContactCurrentEmployer" type="text" placeholder="Because..." value={occupation.ReasonForNotContactCurrentEmployer ?? ""}/>
                    </label>}
                </div>
                <PhoneNumberField value={occupation.Phone}/>
                <label>
